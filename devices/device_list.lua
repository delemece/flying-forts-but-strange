...
table.insert(Sprites, ButtonSprite("hud-tank_h-icon", "HUD/HUD-tank_h", nil, ButtonSpriteBottom, nil, nil, path))
table.insert(Devices, IndexOfDevice("sandbags") + 6,
{
	Enabled = true,
	SaveName = "Tank_H",
	FileName = path .. "/devices/tank_H.lua",
	Icon = "hud-tank_h-icon",
	Detail = "hud-detail-repairstation",
	BuildTimeComplete = 5,
	ScrapPeriod = 1,
	MetalCost = 1000,
