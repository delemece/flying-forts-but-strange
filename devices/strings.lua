...
{
	thruster1 = L"AL-21",
	thruster1Tip2 = L"Most popular thruster around these places. Helm needed to control.",
	...
	tank_STip3 = L"4k fuel units",
	
	Tank_B = L"Medium fuel tank",
	Tank_BTip2 = L"Stores more fuel  (EMPTY WHEN PLACED PLACE FUEL STATON)",
	Tank_BTip3 = L"20k fuel units",
	
	refuel = L"Fuel station",
