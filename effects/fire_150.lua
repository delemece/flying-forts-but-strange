...
{
	{
		...
		States =
		{
			Normal =
			{
				Frames =
				{
					{ texture = path .. "/effects/media/20mmFX01.dds" },
					{ texture = path .. "/effects/media/20mmFX06.dds" },
					{ texture = path .. "/effects/media/20mmFX07.dds" },
					{ texture = path .. "/effects/media/20mmFX00.dds" },
					{ texture = path .. "/effects/media/20mmFX00.dds" },
					{ texture = path .. "/effects/media/20mmFX03.dds", colour = { 1, 1, 1, 0.0 }, duration = 2 }, -- just makes a blank frame long enough to last the rest of the effect
...
Effects =
{
...

	{
		...
		FadeInPeriod = 0.0,
		LocalPosition = { x = 0, y = 0, z = 0 },
		Sound = path .. "/effects/media/150.mp3",
		Volume = 0.7,
		Priority = 192,
		Repeat = false,
